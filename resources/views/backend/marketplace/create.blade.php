...
<div class="kt-portlet kt-portlet--tabs">
    <div class="kt-portlet__body">
      {{ Form::open(array('url' => route('markets.store',$data->id), 'files' => true)) }}
                ...
                <div class="kt-section kt-section--first">
                  <div class="kt-section__body">
                    <div class="form-group row">
                      <label class="col-xl-3 col-lg-3 col-form-label">Rp. {{$data->modal + $data->price}},00</label>
                    </div>
                    <div class="form-group row">
                      <label class="col-xl-3 col-lg-3 col-form-label">Qty</label>
                      <div class="col-lg-9 col-xl-6">
                        {!! Form::number('total',null, ['class' => 'form-control','required'=>'required','min'=>1]) !!}
                        @error('total')
