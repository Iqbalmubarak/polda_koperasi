  ...
  <div class="dropdown-menu dropdown-menu-right">
    <ul class="kt-nav">
      <li class="kt-nav__item">
        <a href="{{route('users.index')}}" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text">@lang('global.app_all') {{$name}}</span>
        </a>
      </li>
      <li class="kt-nav__item">
        <a href="{{route('users.index')}}?user=actived" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text">{{$name}}  @lang('global.app_active')</span>
        </a>
      </li>
      <li class="kt-nav__item">
        <a href="{{route('users.index')}}?user=deactived" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text">{{$name}}  @lang('global.app_deactive')</span>
        </a>
      </li>
      @if (Sentinel::getUser()->hasAccess(['users.activate']))
      <li class="kt-nav__item">
        <a href="javascript::void(0)" id="activate_all" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text"> @lang('global.app_active_selected') {{$name}}</span>
        </a>
      </li>
      @endif
      @if (Sentinel::getUser()->hasAccess(['users.deactivate']))
      <li class="kt-nav__item">
        <a href="javascript::void(0)" id="deactivate_all" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text"> @lang('global.app_deactive_selected') {{$name}}</span>
        </a>
      </li>
      @endif
      @if (Sentinel::getUser()->hasAccess(['users.destroy']))
      <li class="kt-nav__item">
        <a href="javascript::void(0)" id="delete_all" class="kt-nav__link">
          <i class="kt-nav__link-icon flaticon2-writing"></i>
          <span class="kt-nav__link-text"> @lang('global.app_delete_selected') {{$name}}</span>
        </a>
      </li>
      @endif
    </ul>
